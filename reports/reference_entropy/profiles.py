...
def _oracle_axis():
    ...
    return {
         # Standard QQN oracle: L-BFGS with an Adam fallback. Additional
         # oracle variants are intentionally *not* enabled in this report --
         # it studies the entropy gate, not optimizer ablations.
         "": {
            "oracle": Fallback(
...
def _line_search_axis():
    return {
         # Standard Armijo-Wolfe line search (single, fixed configuration).
         "": {
